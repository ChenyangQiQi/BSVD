...
class UNet(nn.Module):
    def __init__(self, channel=5, mid_channel=32, channels1=[32,64,128], channels2=[32,64,128], pretrain=False):
        ...
        # self.shift_num = 
    def load(self, path="./logs/1105_crvd_slimcnn_batch8_lr_1e-4_seq7/ckpt.pth"):
            ckpt = torch.load(path)
            print("load from %s"%path)
            ckpt_state = ckpt['state_dict']
            # split the dict here
...
#%%
cuda_net = UNet(channels1=[16,32,64], channels2=[16,32,64]).cuda()
# %%
with torch.no_grad():
    out_seq = cuda_net.forward(input_seq)
    print(out_seq.shape)
# %%
ckpt = torch.load("../logs/1106_1008_crvd_tswnet16_batch16_lr_1e-4_seq7_nonorm_10_300/ckpt.pth")
ckpt_state = ckpt['state_dict']
path = "../logs/1106_1008_crvd_tswnet16_batch16_lr_1e-4_seq7_nonorm_10_300/ckpt.pth"
cuda_net.load(path)
#%%
m1_dict = {}
m2_dict = {}
...
example_InputCvBlock = InputCvBlock(5,16)
example_InputCvBlock.load_state_dict(extract_dict(ckpt_state, 'base_model.temp1.inc.'))
# %%

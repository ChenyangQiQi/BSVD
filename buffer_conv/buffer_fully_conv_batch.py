...
input_seq = [1,2,3,4]*300
base_tensor = torch.ones(1, 1, 2000, 2000)
...
#     on_trace_ready=torch.profiler.tensorboard_trace_handler('../tb_profile_logger/buffer_fully_length10'),
#     record_shapes=True,
#     with_stack=True,
#     profile_memory=True,
# ) as prof:
...
print("length of output", len(out_seq))
